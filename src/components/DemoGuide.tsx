const demoSteps = [
  ...
  "Run a valid Research spend to see approval.",
  "Run an over-limit spend to see blocking.",
  "Revoke an allowance to prove control.",
    ...
    <section className="rounded-3xl border border-cyan-300/20 bg-cyan-300/10 p-5 shadow-xl shadow-slate-950/30">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-2xl font-bold text-white">Five quick checks for the policy engine demo</h2>
          <p className="mt-2 max-w-3xl text-sm text-cyan-50/80">
            Use these steps to verify approvals, blocks, revocation control, and the audit trail in simulation mode.
          </p>
        </div>
